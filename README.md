...
When explaining something, always start with whiteboarding the algorithm. 
...
► Explain concepts: Ask ChatGPT to summarize concepts or explain them to you in a different way or in simpler terms. 
